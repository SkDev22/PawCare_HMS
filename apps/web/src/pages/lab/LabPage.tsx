    ...
    createOrder.mutate(
      {
        ...
        ...(values.is_external && values.external_lab_name
          ? { external_lab_name: values.external_lab_name }
          : {}),
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                Panel / Test Name <span className="text-destructive">*</span>
              </FormLabel>
              <FormControl>
                <Input
                  placeholder="e.g. CBC, Thyroid Panel, Urinalysis"
                  {...field}
                />
              </FormControl>
              <FormMessage />
